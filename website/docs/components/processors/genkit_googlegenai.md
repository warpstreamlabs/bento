---
title: genkit_googlegenai
slug: genkit_googlegenai
type: processor
status: beta
...
:::
Generates content using Google AI models.
...
Generates text content using Google AI models through the Genkit framework. For more information about Genkit, see https://genkit.dev and https://github.com/firebase/genkit.

## Examples

<Tabs defaultValue="Chat Completion with Google AI" values={[
{ label: 'Chat Completion with Google AI', value: 'Chat Completion with Google AI', },
]}>

<TabItem value="Chat Completion with Google AI">
