...
Generates text content using OpenAI models through the Genkit framework. For more information about Genkit, see https://genkit.dev and https://github.com/firebase/genkit.

## Examples

<Tabs defaultValue="Chat Completion with OpenAI" values={[
{ label: 'Chat Completion with OpenAI', value: 'Chat Completion with OpenAI', },
]}>

<TabItem value="Chat Completion with OpenAI">
