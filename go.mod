...
require (
	...
	github.com/knights-analytics/hugot v0.4.2
...
require (
	...
	github.com/gomlx/go-huggingface v0.2.2-0.20250626134208-e515b14550f3 // indirect
	github.com/gomlx/gomlx v0.20.1 // indirect
