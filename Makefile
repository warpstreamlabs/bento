...
VER_FLAGS = -X github.com/warpstreamlabs/bento/v1/internal/cli.Version=$(VERSION) \
	-X github.com/warpstreamlabs/bento/v1/internal/cli.DateBuilt=$(DATE)
...
fmt:
	...
	@go list -f {{.Dir}} ./... | xargs -I{} goimports -w -local github.com/warpstreamlabs/bento/v1 {}
	@go mod tidy
