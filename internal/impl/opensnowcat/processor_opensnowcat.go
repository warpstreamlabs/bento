...
- **anonymize_ip**: Mask IP addresses while preserving network information
  - IPv4: Mask last N octets (e.g., ` + "`75.80.110.186`" + ` → ` + "`75.80.x.x`" + `)
  - IPv6: Mask last N segments (e.g., ` + "`2001:db8::1`" + ` → ` + "`2001:db8::x:x:x`" + `)
