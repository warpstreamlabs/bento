...
func getTextClassificationOptions(conf *service.ParsedConfig) ([]backends.PipelineOption[*pipelines.TextClassificationPipeline], error) {
	var options []backends.PipelineOption[*pipelines.TextClassificationPipeline]
