...
func TestSchemaRegistryEncodeAvro(t *testing.T) {
	...
	encoder, err := newSchemaRegistryEncoder(urlStr, noopReqSign, nil, subj, false, false, nil, false, time.Minute*10, time.Minute, service.MockResources())
	require.NoError(t, err)
...
func TestSchemaRegistryEncodeAvroRawJSON(t *testing.T) {
	...
	encoder, err := newSchemaRegistryEncoder(urlStr, noopReqSign, nil, subj, true, false, nil, false, time.Minute*10, time.Minute, service.MockResources())
	require.NoError(t, err)
...
func TestSchemaRegistryEncodeJSONConstantRefreshes(t *testing.T) {
	...
	encoder, err := newSchemaRegistryEncoder(urlStr, noopReqSign, nil, subj, false, false, nil, false, time.Millisecond, time.Millisecond*10, service.MockResources())
	require.NoError(t, err)
