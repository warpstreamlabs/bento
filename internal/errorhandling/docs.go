...
func Spec() docs.FieldSpecs {
	return docs.FieldSpecs{
		...
		docs.FieldObject(fieldLog, "Configuration for global logging mmessage-level errors.").WithChildren(
			...
			docs.FieldFloat(fieldLogSamplingRatio, "Sets the ratio of errored messages within a batch to sample.").HasDefault(0).
